...
def compute_lprofile(node, x, y):
    ...
    #print('lp1',x - node.edge_length - 1, y + node.edge_length + 1)
    #print('lp2',x + node.edge_length + 1, y + node.edge_length + 1)
...
def compute_rprofile(node, x, y):
    ...
    #print('rp1',x - node.edge_length - 1, y + node.edge_length + 1)
    #print('rp2',x + node.edge_length + 1, y + node.edge_length + 1)
